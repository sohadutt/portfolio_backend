...
urlpatterns = [
    ...
    path("form_submit/", views.submit_mail_default_portfolio, name="submit_default_portfolio_mail"),
    ...
    path("submissions/", views.list_dashboard_submissions, name="list_dashboard_submissions"),
    path("submissions/reorder/", views.reorder_dashboard_submissions, name="reorder_dashboard_submissions"),
    path("submissions/<int:form_id>/", views.update_dashboard_submission, name="update_dashboard_submission"),
]
